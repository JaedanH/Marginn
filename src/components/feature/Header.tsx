        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <h1 className="text-2xl font-bold text-black tracking-tight">Marginn</h1>
            </Link>
          </div>

          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-gray-700 hover:text-black font-medium cursor-pointer text-sm">
              Home
            </Link>
            <Link to="/pricing" className="text-gray-700 hover:text-black font-medium cursor-pointer text-sm">
              Pricing
            </Link>
          </nav>
