-- Forward repair for existing projects: `scans` may exist from the dashboard without
-- GRANTs for `authenticated` (Postgres error: permission denied for table scans), or
-- columns may predate Edge/client payloads. Idempotent; complements 202605111.
